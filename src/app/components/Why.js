      ...
      <div className="container mx-auto">
        <motion.h2
         ...
         // className="h2 text-center"
          className="h3 font-bold text-center mt-10"
          >
        ...
        <motion.div
          ...
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            <MdKey
              className="text-[38px] text-accent mb-4"
            />
            <h3 className="h3">Rent simply and quickly</h3>
            <p className="hidden xl:flex">
              We prioritize your needs and we go above and beyond to ensure your experience with us is nothing short of outstanding.
            </p>
          </div>
