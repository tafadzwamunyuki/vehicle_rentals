                    ...
                    <div className="xl:max-w-[517px]">
                        ...
                        <motion.div
                            ...
                            <div className="flex flex-col w-[100px]">
                                <MdOutlineDirectionsCar
                                    className="text-5xl text-accent mb-2"
                                />
                        ...
                        <button
                            ...
                            whileInView={"show"}
                            viewport={{once: false, amount: 0.6}}
                            className="uppercase hidden xl:block bg-accent hover:bg-accent-hover rounded-[10px] w-full h-16 font-medium text-white tracking-[2px] text-[13px] max-w-[184px]"
                        >
                            See all cars
                        </button>
                    </div>
